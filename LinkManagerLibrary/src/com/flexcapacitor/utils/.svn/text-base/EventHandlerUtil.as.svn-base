...
package com.flexcapacitor.utils {
	...
	public class EventHandlerUtil {
		...
		public function EventHandlerUtil(target:Object = null, event:String = null, faultEvent:Object = null) {
			// 
		}
		...
		public function addTimeListeners(handler:Handler, target:Object, seconds:Number = 1):void {
		...
		public function addFrameListeners(handler:Handler, target:Object, frames:int = 1, eventName:String = null):void {
			currentFrameIndex = 0;
			this.handler = handler;
			this.frames = frames;
			this.target = target;
		...
		public function addEventListeners(handler:Handler, target:Object, event:Array, faultEvent:Array = null):void {
