...
package com.flexcapacitor.utils {
	...
	public class ElementInspector {
		...
		private var elementInspectorPanel:ElementInspectorPanel; // DEPRECATED
		...
		public function displayPopUp():void {
			if (showNewPanel) {
				...
				PopUpManager.addPopUp(elementInspectorWindow, DisplayObject(ApplicationUtils.getInstance()));
