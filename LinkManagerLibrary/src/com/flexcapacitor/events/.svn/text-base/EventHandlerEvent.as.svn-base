...
package com.flexcapacitor.events {
	...
	public class EventHandlerEvent extends Event {
		...
		public function EventHandlerEvent(type:String, hyperlink:String, linkInfo:LinkInfo) {
			super(type);
		...
		override public function clone():Event {
			return new EventHandlerEvent(type, hyperlink, linkInfo);
		}
	}
}
